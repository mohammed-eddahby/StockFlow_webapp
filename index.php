                ...
                <div class="form-container-wrapper">
                    ...
                    <form id="loginForm" method="POST" action="login_register.php" class="sliding-form space-y-6">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" required pattern="^[^\s@]+@[^\s@]+\.[A-Za-z]{2,}$" title="Veuillez entrer un email valide (ex: nom@domaine.com)" class="clean-input" placeholder="Enter your email">
                        </div>
                    ...
                    <form id="registerForm" method="POST" action="login_register.php" class="sliding-form space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" required pattern="^[^\s@]+@[^\s@]+\.[A-Za-z]{2,}$" title="Veuillez entrer un email valide (ex: nom@domaine.com)" class="clean-input" placeholder="user@stockflow.com">
                        </div>
